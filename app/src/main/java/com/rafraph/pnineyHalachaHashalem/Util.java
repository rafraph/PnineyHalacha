...
public class Util {
    ...
    int[] lastChapter = {18, 9, 10, 17, 10, 10, 19, 19, 13, 16, 13, 10, 8, 16, 11, 30, 10, 26, 24, 17, 10, 12, 8, 30, 10, 26, 16, 15, 24, 30, 26, 30};

    static final int BRACHOT      	= 0;
    static final int GIYUR      	= 1;
    static final int HAAMVEHAAREZ 	= 2;
    static final int ZMANIM    		= 3;
    static final int TAHARAT   		= 4;
    static final int YAMIM    		= 5;
    static final int KASHRUT_A 		= 6;
    static final int KASHRUT_B 		= 7;
    static final int LIKUTIM_A 		= 8;
    static final int LIKUTIM_B 		= 9;
    static final int MOADIM    		= 10;
    static final int MISHPACHA   	= 11;
    static final int SUCOT			= 12;
    static final int PESACH			= 13;
    static final int SHVIIT			= 14;
    static final int SHABAT			= 15;
    static final int SIMCHAT		= 16;
    static final int TEFILA			= 17;
    static final int TEFILAT_NASHIM	= 18;
    static final int HAR_BRACHOT    = 19;
    static final int HAR_YAMIM      = 20;
    static final int HAR_MOADIM     = 21;
    static final int HAR_SUCOT      = 22;
    static final int HAR_SHABAT     = 23;
    static final int HAR_SIMCHAT    = 24;
    static final int BOOKS_HEB_NUMBER	= 25;
    static final int E_TEFILA       = 25;
    static final int E_PESACH       = 26;
    static final int E_ZMANIM       = 27;
    static final int E_WOMEN_PRAYER = 28;
    static final int E_SHABAT       = 29;
    static final int F_TEFILA       = 30;
    static final int S_SHABAT       = 31;
    static final int BOOKS_NUMBER	= 32;
