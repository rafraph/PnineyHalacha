...
public class Util {
    ...
    int[] lastChapter = {30, 18, 9, 10, 17, 10, 10, 19, 19, 13, 16, 13, 10, 8, 16, 11, 30, 10, 26, 24, 17, 10, 12, 8, 30, 10, 26, 16, 15, 24, 30, 26, 30};

    static final int EMUNA          = 0;
    static final int BRACHOT        = 1;
    static final int GIYUR          = 2;
    static final int HAAMVEHAAREZ   = 3;
    static final int ZMANIM         = 4;
    static final int TAHARAT        = 5;
    static final int YAMIM          = 6;
    static final int KASHRUT_A      = 7;
    static final int KASHRUT_B      = 8;
    static final int LIKUTIM_A      = 9;
    static final int LIKUTIM_B      = 10;
    static final int MOADIM         = 11;
    static final int MISHPACHA      = 12;
    static final int SUCOT          = 13;
    static final int PESACH         = 14;
    static final int SHVIIT         = 15;
    static final int SHABAT         = 16;
    static final int SIMCHAT        = 17;
    static final int TEFILA         = 18;
    static final int TEFILAT_NASHIM = 19;
    static final int HAR_BRACHOT    = 20;
    static final int HAR_YAMIM      = 21;
    static final int HAR_MOADIM     = 22;
    static final int HAR_SUCOT      = 23;
    static final int HAR_SHABAT     = 24;
    static final int HAR_SIMCHAT    = 25;
    static final int BOOKS_HEB_NUMBER	= 26;
    static final int E_TEFILA       = 26;
    static final int E_PESACH       = 27;
    static final int E_ZMANIM       = 28;
    static final int E_WOMEN_PRAYER = 29;
    static final int E_SHABAT       = 30;
